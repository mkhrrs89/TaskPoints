...
const CORE_BUNDLE_ASSET_PATHS = Object.freeze([
  ...
  '/state_runtime_v2_generation.js',
  '/state_runtime_v2_wal.js',
  '/state_runtime_v2.js',
...
async function buildCoreBundle(request, env, ctx, version) {
  ...
  const [perfSource, aliasSource, youAliasSource, habitGuardSource, habitFastPathControlSource, stateRuntimeV2GenerationSource, stateRuntimeV2WalSource, stateRuntimeV2Source, stateRuntimeV2WalBridgeSource, sharedSaveWorkSource, inboxBadgeSource, seasonSeriesUpsetSource, taskMutationJournalSource, taskCreateFastPathSource, stateHotCacheSource, storageIdleSource] = await Promise.all([
    ...
    readAssetSource(env, request, '/state_runtime_v2_generation.js'),
    readAssetSource(env, request, '/state_runtime_v2_wal.js'),
  ...
  return immutableJavascriptResponse(source, response, version, {
    ...
    'x-taskpoints-state-runtime-v2-generation': stateRuntimeV2GenerationSource ? 'included' : 'missing',
    'x-taskpoints-state-runtime-v2-wal': stateRuntimeV2WalSource ? 'included' : 'missing',
