(function installTaskPointsStateRuntimeV2HabitStructureBridge(global) {
  ...
  function installHotPresenceEnqueue() {
    ...
    if (wrapperChainContains(candidate, '__tpStateV2HotPresenceEnqueueWrapped')) return true;
  ...
  function loadPerfInstrumentation() {
    ...
    script.src = '/state_runtime_v2_perf.js?v=20260912-1';
    script.defer = true;
  ...
  function loadLiveTraceReview() {
    ...
    const script = global.document.createElement('script');
    script.src = '/state_runtime_v2_live_review.js?v=20260912-1';
    script.defer = true;
