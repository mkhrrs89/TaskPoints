...
assert.match(worker, /handleCoreBundleRequest/);
assert.match(worker, /CORE_BUNDLE_ASSET_PATHS/);
assert.match(worker, /score_alias_consistency\.js/);
assert.match(worker, /x-taskpoints-score-alias-bundle/);
assert.match(worker, /max-age=\$\{CORE_BUNDLE_BROWSER_MAX_AGE\}, immutable/);
