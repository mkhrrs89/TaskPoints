...
test('Home season upset reconciliation does not request heavyweight derived-state synchronization', () => {
  ...
  assert.match(body, /const loadOptions = \{ syncDerived: false, persistSync: false \}/);
  assert.doesNotMatch(body, /const loadOptions = \{ syncDerived: true/);
