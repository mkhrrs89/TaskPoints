...
<div class="dropdown-menu">
  ...
  <a href="tournament.html" class="btn btn-teal btn-toolbar nav-btn">Tourney</a>
...
function readNotesPayloadFromBackupPayloadFallback(payload) {
  ...
  if (hasOwn(payload.aux, 'taskpoints_notes_v1')) return payload.aux.taskpoints_notes_v1;
  if (hasOwn(payload, 'taskpoints_notes_v1')) return payload.taskpoints_notes_v1;
  if (hasOwn(payload.notesBackup, 'taskpoints_notes_v1')) return payload.notesBackup.taskpoints_notes_v1;
  if (hasOwn(payload.state, 'notes')) return payload.state.notes;
  if (hasOwn(payload, 'notes')) return payload.notes;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function ensureTodayScoreIsland() {
    ...
    // Create if missing
    let island = document.getElementById('todayScoreIsland');
    if (!island) {
